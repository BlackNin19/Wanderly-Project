...
function loadGuides() {
    fetch("https://wanderly-project-o7s2.onrender.com/guides")
        .then(res => {
        ...
        .then(data => {
            ...
            data.forEach(g => {
                ...
                const imgSrc = g.image
                    ? `https://wanderly-project-o7s2.onrender.com/static/uploads/${g.image}`
...
function confirmBooking() {
    ...
    fetch("https://wanderly-project-o7s2.onrender.com/guide-bookings", {
        method: "POST",
        headers: {
...
function loadReviews(entityType, entityId, containerId) {
    fetch(`https://wanderly-project-o7s2.onrender.com/reviews?entity_type=${entityType}&entity_id=${entityId}`)
        .then(res => {
